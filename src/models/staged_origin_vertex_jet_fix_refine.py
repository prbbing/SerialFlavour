"""
Staged three-encoder transformer jet-flavour classifier (additive refine).
...
class StagedOriginVertexJetTransformerFixRefine(nn.Module):
...
def build_staged_origin_vertex_jet_fix_refine(config):
    return StagedOriginVertexJetTransformerFixRefine(
