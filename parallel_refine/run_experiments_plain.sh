...
CUDA_VISIBLE_DEVICES=0 python -m parallel_refine.training.evaluate --config parallel_refine/configs/experiments/default.json --seed 1 --model direct_dnn >parallel_refine/logs/plain/y_evaluate_seed1_gpu0.log 2>&1 &
CUDA_VISIBLE_DEVICES=1 python -m parallel_refine.training.evaluate --config parallel_refine/configs/experiments/default.json --seed 2 --model direct_dnn >parallel_refine/logs/plain/y_evaluate_seed2_gpu1.log 2>&1 &
CUDA_VISIBLE_DEVICES=1 python -m parallel_refine.training.evaluate --config parallel_refine/configs/experiments/default.json --seed 3 --model direct_dnn >parallel_refine/logs/plain/y_evaluate_seed3_gpu1.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 python -m parallel_refine.training.evaluate --config parallel_refine/configs/experiments/default.json --seed 4 --model direct_dnn >parallel_refine/logs/plain/y_evaluate_seed4_gpu2.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 python -m parallel_refine.training.evaluate --config parallel_refine/configs/experiments/default.json --seed 5 --model direct_dnn >parallel_refine/logs/plain/y_evaluate_seed5_gpu2.log 2>&1 &
wait
